...
class HTSCOMPONENT_EXPORT HydraulicsTimeSeriesBC : public AbstractTimeSeriesBC
{
  public:

    HydraulicsTimeSeriesBC(Element *element, int variableIndex, HTSModel *model);
...
class HTSCOMPONENT_EXPORT UniformHydraulicsTimeSeriesBC : public AbstractTimeSeriesBC
{
  public:

    UniformHydraulicsTimeSeriesBC(Element *startElement, Element *endElement, int variableIndex, HTSModel *model);
