...
void HTSComponentTest::solveODERK4_Prob1()
{
  QBENCHMARK
  {
    ...
    while(t + dt < maxt)
    {
      solver.solve(&y, 1, t, dt, &y_out, &HTSComponentTest::derivativeProb1, nullptr);
...
void HTSComponentTest::solveODERKQS_Prob1()
{
...
void HTSComponentTest::solveODEAdam_Prob1()
{
...
void HTSComponentTest::solveODEBDF_Prob1()
{
...
void HTSComponentTest::solveODERK4_Prob2()
{
  //  printf("RK4\n");
  ...
  QBENCHMARK
  {
    ...
    while(t + dt < maxt)
    {
      solver.solve(&y, 1, t, dt, &y_out, &HTSComponentTest::derivativeProb2, nullptr);
...
void HTSComponentTest::solveODERKQS_Prob2()
{
  //  printf("RKQS\n");
...
void HTSComponentTest::solveODEAdam_Prob2()
{
  //  printf("RKQS\n");
...
void HTSComponentTest::solveODEBDF_Prob2()
{
  //  printf("RKQS\n");
...
//void HTSComponentTest::versteegCase1_Upwind()
//{
//QBENCHMARK_ONCE
//  {
...
//void HTSComponentTest::versteegCase1_Central()
//{
//QBENCHMARK_ONCE
//  {
//    std::list<std::string> errors;
...
//void HTSComponentTest::versteegCase1_Hybrid()
//{
//QBENCHMARK_ONCE
//  {
//    std::list<std::string> errors;
...
//void HTSComponentTest::versteegCase2_Upwind()
//{
//  QBENCHMARK_ONCE
//  {
//    std::list<std::string> errors;
...
//void HTSComponentTest::versteegCase2_Central()
//{
//  QBENCHMARK_ONCE
//  {
//    std::list<std::string> errors;
...
//void HTSComponentTest::versteegCase2_Hybrid()
//{
//  QBENCHMARK_ONCE
//  {
...
void HTSComponentTest::derivativeProb1(double t, double y[], double dydt[], void *userData)
{
  dydt[0] = t * pow(y[0],3) / sqrt(1 + t * t);
}

double HTSComponentTest::problem1(double t)
{
  return -1.0 / sqrt(3.0 - 2.0 * sqrt(1+t*t));
}

void HTSComponentTest::derivativeProb2(double t, double y[], double dydt[], void* userData)
{
  dydt[0] = (3 * t*t + 4 * t - 4)/(2 * y[0] - 4);
}

double HTSComponentTest::problem2(double t)
{
