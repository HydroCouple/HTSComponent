            ...
            case -1:
              {
                for(size_t i = 0; i < m_profile.size(); i++)
                {
                  ...
                  {
                    m_profile[i]->mainChannelTemperature = value;
                  }
                }
              }
              break;
            default:
              {
                for(size_t i = 0; i < m_profile.size(); i++)
                {
                  if(m_timeSeries->interpolate(dateTime, i, m_dataCursor, value))
                  {
                    m_profile[i]->mainChannelSoluteConcs[m_variableIndex] = value;
                  }
                }
              }
              break;
            ...
            case -1:
              {
                for(size_t i = 0; i < m_profile.size(); i++)
                {
                  if(m_timeSeries->interpolate(dateTime, i, m_dataCursor, value))
                  {
                    m_profile[i]->groundTemperature = value;
                  }
                }
              }
              break;
            default:
              {
                for(size_t i = 0; i < m_profile.size(); i++)
                {
                  if(m_timeSeries->interpolate(dateTime, i, m_dataCursor, value))
                  {
//                    m_profile[i]->groundSoluteConcs[m_variableIndex] = value;
                  }
                }
              }
              break;
